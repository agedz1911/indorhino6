    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="w-full px-3 md:px-8">
            <div class="w-full pt-5">
                ...
                <p class="mt-3">{{ __('home.promo_event')}} 
                <a href="{{route('pre-event')}}" wire:navigate class="text-[#be124e] hover:text-red-800"> {{__('home.read_more')}}</a>
                </p>
                <div class="mt-7 flex gap-4 flex-wrap">
                    <button
                        class="btn hover:bg-[#be124e] hover:border-[#be124e] shadow-none hover:text-white rounded-lg btn-lg text-sm px-5 lg:px-10">{{__('home.read_more')}}
        ...
        <div class="flex flex-col items-center">
            <div class="pt-20 pb-10 justify-center flex md:items-center lg:items-start flex-col lg:flex-row gap-5">
                ...
                <div class="flex flex-col items-start md:flex-row ">
                    <div class="flex justify-around md:justify-center w-full max-w-xs gap-2">
                        <div class="w-24 rounded-md">
                            <img src="assets/images/lussy.jpg" class="object-cover w-full rounded-lg"
                                alt="Lussy" />
                        </div>
                        <div class="w-24 rounded-md">
                            <img src="assets/images/vicky.jpg" class="object-cover w-full rounded-lg"
                                alt="vicky" />
                        </div>
                    </div>
            ...
            <div class="card bg-base-100 w-full  shadow-xl">
                <div class="card-body ">
                    ...
                    <div class="line-clamp-6 mt-4">{!! $message->description !!}
                    </div>
    ...
    document.addEventListener('livewire:navigated', function() {
        try {
            if (document.getElementById("days")) {
                ...
                var eventCountDown = new Date("June 4, 2026 08:37:52").getTime();
